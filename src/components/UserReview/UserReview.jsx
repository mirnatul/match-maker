                        ...
                        <div className='mb-12 mt-4'>
                            ...
                            <div className='flex justify-center items-center'>
                                <div className="flex flex-col justify-center bg-white text-lg h-full px-16">
                                    <p className='md:text-2xl text-xl max-w-[1200px] mb-12'>Hinge's prompts really made the difference - I felt like I got a good sense of a guy's vibe from his answers, and it way easy to jump right into real conversation.</p>
